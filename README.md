...
Полное описание работы содержится в файле 
## Цель
...
По завершению разработки концепции и реставрационных работ, в том числе, создан новый аттрактор – проектное предложение (единая концепция) для конкретного объекта культурного наследия. 

## Автор
Глушакова Елизавета - студентка 2 курса магистратуры направления "Цифровая Урбанистика" Университета ИТМО.
Дрожжин Андрей Игоревич - научный руководитель, заместитель директора Института дизайна и урбанистики Университета ИТМО.
